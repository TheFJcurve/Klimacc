...
lblheading = Label(frame2, text="Join Klimacc!", font=(
    "Helvetica Bold", 20), anchor="center", bg="#000834", fg="white")
lblheading.place(relx=0.3, rely=0.01)

# making the login and sign in buttons
btnloginexisting = Button(frame2, text="Sign In", font=(
    'Ubuntu Light', 13, 'bold'),  fg="#000834", bg='#fb5b8d', command=clickedexisting)
btnloginexisting.place(relx=0.17, rely=0.75, relheight=0.1, relwidth=0.2)

btnloginnewuser = Button(frame2, text="Sign Up", font=(
    'Ubuntu Light', 13, 'bold'), fg="#000834", bg='#fb5b8d', command=clickednewuser)
